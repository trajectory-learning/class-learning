...
% demo1, demo2, demo3...demN - contain the input data for the algorithm (demonstrations),
%                           this data is gathered by the experimental setup in the teaching process
% 
% script(1)(2)(3).txt - contain the demonstrated trajectories by kinesthetic teaching,
%                       sampled from the UR robot
% TauN(1)(2)(3).txt - contain the object positions and orientations (X,Y,W-per row/object)
%                    before kinesthetic teaching (initial configuration) captured by the Kinect sensor
% demoN/konfigN/ - contain different configurations of the robot workspace 
%                   (object locations and robot initial position)
% 
% scriptX.txt - contain the initial position of the UR robot for a new situation
% TauNX.txt - contains the initial position of the objects for a new situation (X,Y,W-per row/object)
...
%%  determining the orientation variability
...
[xmin,fmin,counteval,stopflag, out, bestever] = cmaes_v2('cost_trajektorija_gh',xNullVec,iniSTD, OPTS);
